...
do-analysis: analysis_output/grep_dynamic.csv \
			 analysis_output/grep_static.csv \
			 analysis_output/ocamlrun_dynamic.csv \
			 analysis_output/ocamlrun_static.csv
...
built_llvm_binaries/ocamlrun_dynamic.bc: built_llvm_binaries
	...
	cp $(OCAML_SOURCE)/runtime/ocamlrun.bc built_llvm_binaries/ocamlrun_dynamic.bc

# OCaml runtime, built from source using static linking
built_llvm_binaries/ocamlrun_static.bc: built_llvm_binaries
	...
	@echo "Extracting LLVM bitcode"
	$(GET_BC) $(OCAML_SOURCE)/runtime/ocamlrun
	cp $(OCAML_SOURCE)/runtime/ocamlrun.bc built_llvm_binaries/ocamlrun_static.bc

# Use llvm-dis to disassemble .bc files into .ll files
.PRECIOUS: built_llvm_binaries/%.ll  # Don't automatically delete
